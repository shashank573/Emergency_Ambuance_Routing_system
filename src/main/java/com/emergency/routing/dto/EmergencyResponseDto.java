...
public class EmergencyResponseDto {
    ...
    public List<CoordinateDto> getRouteAmbulanceToPatient() { return routeAmbulanceToPatient; }
    public void setRouteAmbulanceToPatient(List<CoordinateDto> routeAmbulanceToPatient) {
        this.routeAmbulanceToPatient = routeAmbulanceToPatient;
    }
    public List<CoordinateDto> getRoutePatientToHospital() { return routePatientToHospital; }
    public void setRoutePatientToHospital(List<CoordinateDto> routePatientToHospital) {
